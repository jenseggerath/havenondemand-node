...
HODClient.prototype.setOptions=function(opts){
  needle.defaults(opts);
  
  // special handling for proxy option, because needle does not seem to consider this from the defaults.
