...
needle.defaults({ timeout: 120000, proxy: '127.0.0.1:8888', rejectUnauthorized: false });
...
//  console.log('incall',data)
  ...
  return needle.post(url, data, { multipart: true, proxy: 'http://127.0.0.1:8888' }); // uncomment for charles proxy debugging
  // return needle.post(url, data, { multipart: true }); // uncomment for reqular usage
  }
  else{
    ...
    needle.post(url, data, { multipart: true, proxy: 'http://127.0.0.1:8888' }, callbackmanager); // uncomment for charles proxy debugging
    // needle.post(url, data, { multipart: true}, callbackmanager); // uncomment for reqular usage
